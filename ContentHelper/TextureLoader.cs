namespace ContentHelper
{
    ...
    public class TextureLoader
    {
        ...
        public TextureLoader(GraphicsDevice graphicsDevice, bool needsBmp = false, string rootPath = null)
        {
        ...
        {
            using (Stream fileStream = File.OpenRead(string.IsNullOrEmpty(_rootPath) ? path : Path.Combine(_rootPath, path)))
